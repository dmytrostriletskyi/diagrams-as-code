...
| `aws.database.DatabaseMigrationService, DMS (alias)`              | <img width="90" src="../../docs/images/resources/aws/database/database-migration-service.png">                             |
| `aws.database.Database, DB (alias)`                               | <img width="90" src="../../docs/images/resources/aws/database/database.png">                                               |
| `aws.database.DocumentdbMongodbCompatibility, DocumentDB (alias)` | <img width="90" src="../../docs/images/resources/aws/database/documentdb-mongodb-compatibility.png">                       |
...
| `aws.database.DynamodbDax, DAX (alias)`                           | <img width="90" src="../../docs/images/resources/aws/database/dynamodb-dax.png">                                           |
| `aws.database.DynamodbGlobalSecondaryIndex, DynamodbGSI (alias)`  | <img width="90" src="../../docs/images/resources/aws/database/dynamodb-global-secondary-index.png">                        |
...
| `aws.database.Dynamodb, DDB (alias)`                              | <img width="90" src="../../docs/images/resources/aws/database/dynamodb.png">                                               |
...
| `aws.database.Elasticache, ElastiCache (alias)`                   | <img width="90" src="../../docs/images/resources/aws/database/elasticache.png">                                            |
...
| `aws.database.QuantumLedgerDatabaseQldb, QLDB (alias)`            | <img width="90" src="../../docs/images/resources/aws/database/quantum-ledger-database-qldb.png">                           |
...
| `aws.devtools.CommandLineInterface, CLI (alias)` | <img width="90" src="../../docs/images/resources/aws/devtools/command-line-interface.png"> |
| `aws.devtools.DeveloperTools, DevTools (alias)`  | <img width="90" src="../../docs/images/resources/aws/devtools/developer-tools.png">        |
...
| `aws.engagement.SimpleEmailServiceSes, SES (alias)` | <img width="90" src="../../docs/images/resources/aws/engagement/simple-email-service-ses.png">       |
...
| `aws.general.GenericOfficeBuilding, OfficeBuilding (alias)` | <img width="90" src="../../docs/images/resources/aws/general/generic-office-building.png"> |
...
| `aws.integration.SimpleNotificationServiceSns, SNS (alias)`     | <img width="90" src="../../docs/images/resources/aws/integration/simple-notification-service-sns.png">                    |
...
| `aws.integration.SimpleQueueServiceSqs, SQS (alias)`            | <img width="90" src="../../docs/images/resources/aws/integration/simple-queue-service-sqs.png">                           |
| `aws.integration.StepFunctions, SF (alias)`                     | <img width="90" src="../../docs/images/resources/aws/integration/step-functions.png">                                     |

## aws.iot
| Type                                         | Image                                                                                   |
|----------------------------------------------|-----------------------------------------------------------------------------------------|
| `aws.iot.Freertos, FreeRTOS (alias)`         | <img width="90" src="../../docs/images/resources/aws/iot/freertos.png">                 |
...
| `aws.iot.IotHardwareBoard, IotBoard (alias)` | <img width="90" src="../../docs/images/resources/aws/iot/iot-hardware-board.png">       |
...
| `aws.management.SystemsManagerParameterStore, ParameterStore (alias)` | <img width="90" src="../../docs/images/resources/aws/management/systems-manager-parameter-store.png">          |
...
| `aws.management.SystemsManager, SSM (alias)`                          | <img width="90" src="../../docs/images/resources/aws/management/systems-manager.png">                          |
...
| Type                                                     | Image                                                                                              |
|----------------------------------------------------------|----------------------------------------------------------------------------------------------------|
| `aws.migration.ApplicationDiscoveryService, ADS (alias)` | <img width="90" src="../../docs/images/resources/aws/migration/application-discovery-service.png"> |
| `aws.migration.CloudendureMigration, CEM (alias)`        | <img width="90" src="../../docs/images/resources/aws/migration/cloudendure-migration.png">         |
| `aws.migration.DatabaseMigrationService, DMS (alias)`    | <img width="90" src="../../docs/images/resources/aws/migration/database-migration-service.png">    |
...
| `aws.migration.MigrationAndTransfer, MAT (alias)`        | <img width="90" src="../../docs/images/resources/aws/migration/migration-and-transfer.png">        |
| `aws.migration.MigrationHub`                             | <img width="90" src="../../docs/images/resources/aws/migration/migration-hub.png">                 |
| `aws.migration.ServerMigrationService, SMS (alias)`      | <img width="90" src="../../docs/images/resources/aws/migration/server-migration-service.png">      |
...
| `aws.ml.DeepLearningContainers, DLC (alias)` | <img width="90" src="../../docs/images/resources/aws/ml/deep-learning-containers.png"> |
...
| `aws.network.CloudFront, CF (alias)`                  | <img width="90" src="../../docs/images/resources/aws/network/cloudfront.png">                        |
| `aws.network.DirectConnect`                           | <img width="90" src="../../docs/images/resources/aws/network/direct-connect.png">                    |
| `aws.network.ElasticLoadBalancing, ELB (alias)`       | <img width="90" src="../../docs/images/resources/aws/network/elastic-load-balancing.png">            |
| `aws.network.ElbApplicationLoadBalancer, ALB (alias)` | <img width="90" src="../../docs/images/resources/aws/network/elb-application-load-balancer.png">     |
| `aws.network.ElbClassicLoadBalancer, CLB (alias)`     | <img width="90" src="../../docs/images/resources/aws/network/elb-classic-load-balancer.png">         |
| `aws.network.ElbNetworkLoadBalancer, NLB (alias)`     | <img width="90" src="../../docs/images/resources/aws/network/elb-network-load-balancer.png">         |
| `aws.network.Endpoint`                                | <img width="90" src="../../docs/images/resources/aws/network/endpoint.png">                          |
| `aws.network.GlobalAccelerator, GAX (alias)`          | <img width="90" src="../../docs/images/resources/aws/network/global-accelerator.png">                |
...
| `aws.security.CertificateManager, ACM (alias)`                                         | <img width="90" src="../../docs/images/resources/aws/security/certificate-manager.png">                                              |
| `aws.security.CloudDirectory`                                                          | <img width="90" src="../../docs/images/resources/aws/security/cloud-directory.png">                                                  |
| `aws.security.Cloudhsm, CloudHSM (alias)`                                              | <img width="90" src="../../docs/images/resources/aws/security/cloudhsm.png">                                                         |
...
| `aws.security.DirectoryService, DS (alias)`                                            | <img width="90" src="../../docs/images/resources/aws/security/directory-service.png">                                                |
| `aws.security.FirewallManager, FMS (alias)`                                            | <img width="90" src="../../docs/images/resources/aws/security/firewall-manager.png">                                                 |
| `aws.security.Guardduty`                                                               | <img width="90" src="../../docs/images/resources/aws/security/guardduty.png">                                                        |
| `aws.security.IdentityAndAccessManagementIamAccessAnalyzer, IAMAccessAnalyzer (alias)` | <img width="90" src="../../docs/images/resources/aws/security/identity-and-access-management-iam-access-analyzer.png">               |
...
| `aws.security.IdentityAndAccessManagementIamAWSSts, IAMAWSSts (alias)`                 | <img width="90" src="../../docs/images/resources/aws/security/identity-and-access-management-iam-aws-sts.png">                       |
...
| `aws.security.IdentityAndAccessManagementIamPermissions, IAMPermissions (alias)`       | <img width="90" src="../../docs/images/resources/aws/security/identity-and-access-management-iam-permissions.png">                   |
| `aws.security.IdentityAndAccessManagementIamRole, IAMRole (alias)`                     | <img width="90" src="../../docs/images/resources/aws/security/identity-and-access-management-iam-role.png">                          |
...
| `aws.security.IdentityAndAccessManagementIam, IAM (alias)`                             | <img width="90" src="../../docs/images/resources/aws/security/identity-and-access-management-iam.png">                               |
...
| `aws.security.KeyManagementService, KMS (alias)`                                       | <img width="90" src="../../docs/images/resources/aws/security/key-management-service.png">                                           |
...
| `aws.security.ResourceAccessManager, RAM (alias)`                                      | <img width="90" src="../../docs/images/resources/aws/security/resource-access-manager.png">                                          |
...
| `aws.storage.CloudendureDisasterRecovery, CDR (alias)` | <img width="90" src="../../docs/images/resources/aws/storage/cloudendure-disaster-recovery.png">                 |
...
| `aws.storage.ElasticBlockStoreEBS, EBS (alias)`        | <img width="90" src="../../docs/images/resources/aws/storage/elastic-block-store-ebs.png">                       |
...
| `aws.storage.ElasticFileSystemEFS, EFS (alias)`        | <img width="90" src="../../docs/images/resources/aws/storage/elastic-file-system-efs.png">                       |
...
| `aws.storage.Fsx, FSx (alias)`                         | <img width="90" src="../../docs/images/resources/aws/storage/fsx.png">                                           |
...
| `aws.storage.SimpleStorageServiceS3, S3 (alias)`       | <img width="90" src="../../docs/images/resources/aws/storage/simple-storage-service-s3.png">                     |
